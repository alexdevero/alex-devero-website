// Particles custom component
// https://codepen.io/JulianLaval/pen/KpLXOO?editors=1010

const particlesCustom = (canvasDiv, options) => {
  !((a) => {
    console.log('Particles custom running');
    ...
    return (
      ...
      (b.prototype.init = function() {
        ...
        (this.canvas = document.createElement('canvas')),
          ...
          (this.o = []);
        for (let a = 0; a < this.canvas.width * this.canvas.height / this.options.density; a++
        )
          this.o.push(new c(this));
