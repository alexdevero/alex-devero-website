...
const fishSea = () => {
  ...
  var step = function() {
    // print info
    info.innerHTML = window.location.href.indexOf('-cs') !== -1 ? 'Info:<br>Implementace autonomních agentů<br>kombinovaných s genetickými algoritmy.<br><br>Současná populace: ' + sea.population.length : 'Info:<br>Implementation of autonomous agents<br>combined with genetic algorithms.<br><br>Current population: ' + sea.population.length;
